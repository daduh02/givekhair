    ...
    <div style={{ minHeight: "100vh", background: "#F6F1E8", display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }}>
      <div style={{ width: "100%", maxWidth: "360px" }}>
        ...
        <div style={{ background: "white", borderRadius: "1rem", padding: "1.5rem", boxShadow: "0 4px 24px rgba(18,78,64,0.1)" }}>
          ...
          {error && (
            <div style={{ marginBottom: "1rem", padding: "10px 14px", borderRadius: "10px", background: "#FEE2E2", color: "#991B1B", fontSize: "0.8rem" }}>
              Sign in failed — please try again.
            </div>
          )}

          {/* Next-Auth v5 uses POST to /api/auth/signin with providerId in body */}
          <form method="POST" action="/api/auth/signin/google">
            <input type="hidden" name="callbackUrl" value={searchParams.callbackUrl ?? "/admin"} />
            <button
              type="submit"
              style={{
                width: "100%",
          ...
          <p style={{ marginTop: "1rem", fontSize: "0.75rem", color: "#8A9E94", textAlign: "center" }}>
