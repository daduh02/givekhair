...
export function DonationSummary({ summary, loading = false }: DonationSummaryProps) {
  const cards = [
    ...
    { label: "Direct", value: summary.direct, hint: "Direct-to-charity appeal donations" },
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[color:var(--color-ink-muted)]">
            A live breakdown of this appeal&apos;s direct giving, fundraiser-driven support, and offline entries already recorded in GiveKhair.
          </p>
        </div>
      </div>
